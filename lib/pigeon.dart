...
class UserApi {
  ...
  Future<UserDetails> getUserDetails() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.old_people.UserApi.getUserDetails$pigeonVar_messageChannelSuffix';
  ...
  Future<void> saveUserDetails(UserDetails details) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.old_people.UserApi.saveUserDetails$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[details]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
